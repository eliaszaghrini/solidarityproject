    ...
    return (
        <View>
            ...
            <StickyContainer>
                ...
                <View>
                    <div style={{ marginTop: -60 }} id={'whatWeAreDoing'} ></div>
                </View>
                ...
                <View>
                    <div style={{ marginTop: -59 }} id={'whoWeAre'} />
                </View>
                ...
                <View style={frontStyle.containerSection5}>
                    ...
                    <Text style={[frontStyle.body, { width: "90%", color: "white" }]}>Sharing with friends and family could help Solidarity raise the money it needs to help those in need in Lebanon.</Text>
                ...
                <View style={frontStyle.containerSection6}>
                    <View style={{ flexDirection: "row", marginTop: 10 }}>
                        <Link to="/getInTouch" style={{ textDecoration: 'none' }}>
                            <TouchableOpacity style={[frontStyle.footerBtn, { marginStart: 20, width: 98 }]}>GET IN TOUCH</TouchableOpacity>
                        </Link>
